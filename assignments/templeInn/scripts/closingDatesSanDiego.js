...
document.getElementById("date1").innerHTML = data.temples[3].closings[0];
document.getElementById("date2").innerHTML = data.temples[3].closings[1];
document.getElementById("date3").innerHTML = data.temples[3].closings[2];
document.getElementById("date4").innerHTML = data.temples[3].closings[3];
document.getElementById("date5").innerHTML = data.temples[3].closings[4];
